...
cargo test --locked --lib --features device-reader,sd-write-diagnostic,epub --target "$HOST_TARGET"
...
for features in '' sd-write-diagnostic sd-diagnostic device-reader; do
